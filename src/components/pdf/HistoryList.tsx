...
import { getCompensationInfo, getIncomeInfo, getPurchaseInfo } from '../../utils/common'
import { displayBeneficiaryNames } from '../../utils/display'
import { isCompensation, isFirst, isIncome, isLast, isPurchase } from '../../utils/guard'
